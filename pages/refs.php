...
<!--         <div class="container--subtitle">
            <button class="subtitleButtons">Czynni</button>
            <button class="subtitleButtons">Nieczynni</button>
        </div> -->
        <div class=" refs--container">
                ...
                <div class="refs--container--person" id="FR">
                    <div class="refs--container--person--logo" onClick="openPopup(11)">
                        <img src="../images/persons/FRobert.PNG" alt="zdjęcie Robert Frączkiewicz" class="refs--container--person--logo--image">
                        <p class="refs--container--person--logo--name">Robert Frączkiewicz</p>
                        <p> Sędzia klasy "A"</p>
                        <div class="refs--container--person--logo--btnBox">
                ...
                <div class="refs--container--person" id="BM">
                    <div class="refs--container--person--logo" onClick="openPopup(12)">
                        ...
                        <p> Sędzia klasy "B"</p>
                        <div class="refs--container--person--logo--btnBox">
                            <button onClick="openPopup(12)" class="refs--container--person--logo--btnBox--btn">więcej</button>
                        </div>
                    </div>
                </div>
                <div class="refs--container--person" id="JJ">
                    <div class="refs--container--person--logo" onClick="openPopup(13)">
                        ...
                        <p> Sędzia asystent</p>
                        <div class="refs--container--person--logo--btnBox">
                            <button onClick="openPopup(13)" class="refs--container--person--logo--btnBox--btn">więcej</button>
                        </div>
                    </div>
                </div>
                <div class="refs--container--person" id="SB">
                    <div class="refs--container--person--logo" onClick="openPopup(14)">
                        ...
                        <p> Sędzia asystent</p>
                        <div class="refs--container--person--logo--btnBox">
                            <button onClick="openPopup(14)" class="refs--container--person--logo--btnBox--btn">więcej</button>
                        </div>
                    </div>
                </div>

                <div class="refs--container--person" id="MT">
                    <div class="refs--container--person--logo" onClick="openPopup(15)">
                        <img src="../images/persons/face.png" alt="zdjęcie uśmiech" class="refs--container--person--logo--image">
                        <p class="refs--container--person--logo--name">Tomasz Mazur</p>
                        <p> Sędzia asystent</p>
                        <div class="refs--container--person--logo--btnBox">
                            <button onClick="openPopup(15)" class="refs--container--person--logo--btnBox--btn">więcej</button>
                        </div>
                    </div>
                </div>

                <div class="refs--container--person" id="DK">
                    <div class="refs--container--person--logo" onClick="openPopup(16)">
                        <img src="../images/persons/face.png" alt="zdjęcie uśmiech" class="refs--container--person--logo--image">
                        <p class="refs--container--person--logo--name">Kacper Drzazga</p>
                        <p> Sędzia asystent</p>
                        <div class="refs--container--person--logo--btnBox">
                            <button onClick="openPopup(16)" class="refs--container--person--logo--btnBox--btn">więcej</button>
                        </div>
                    </div>
                </div>
